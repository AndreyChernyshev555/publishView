...
export default function CartSummary() {
  ...
  return (
    <div className="cart-summary">
      <div className="cart-summary_head">Cart Summary</div>
      <div className="cart-summary_choice">
        <div className="cart-summary_choice-item">
          ...
          <div className="cart-summary_choice-right">$0.00</div>
        </div>
        <div className="cart-summary_choice-item">
          <div className="cart-summary_choice-left">
            <input
          ...
          <div className="cart-summary_choice-right">+$15.00</div>
        </div>
        <div className="cart-summary_choice-item">
          <div className="cart-summary_choice-left">
            <input
          ...
          <div className="cart-summary_choice-right">%21.00</div>
        </div>
      </div>
      <div className="cart-summary_subtotal">
        <div className="cart-summary_subtotal-left">Subtotal</div>
        <div className="cart-summary_subtotal-right">
